        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
          <div className="h-16 px-4 sm:px-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-black text-gray-900 tracking-tight">Airlines Report</h1>
                <p className="text-xs text-gray-500">Detailed analysis by airline performance & issue tracking</p>
              </div>
            </div>
          </div>
