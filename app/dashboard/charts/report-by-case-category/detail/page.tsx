...
export default function ReportByCaseCategoryPage() {
  ...
  // Parse filter criteria if available
  ...
  // Also read URL params for date range if available (for detail pages that use them)
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5]">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        ...
        {/* Filter Bar - Hidden for filtered dashboards */}
        {!hideFilters && (
