...
import { ArrowLeft, AlertCircle, Loader2, Wrench } from 'lucide-react';
            ...
            <div className="border-b border-[var(--surface-4)] sticky top-0 z-30" style={{ background: `linear-gradient(135deg, ${DIVISION.color}, ${DIVISION.color}dd)` }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center gap-4">
                        <button onClick={() => router.push('/dashboard/ot/reports')} className="p-2 -ml-2 rounded-full hover:bg-white/20 transition-colors">
